...
/*
static  const  TELNETs_CFG  telnet_p_cfg = {
        .Port = 23
		//.IP_Type = TELNETs_IP_TYPE_IPv4 ,
		//.SecureCfgPtr = DEF_NULL
};*/
/********************************************************************************************************
 ********************************************************************************************************
 *                                               DEFINES
...
#define  EX_TELNET_USERNAME         "cpc"
#endif

#ifndef  EX_TELNET_PASSWORD
#define  EX_TELNET_PASSWORD         "cpc"
#endif
...
void Ex_TELNET_Server_InstanceCreate(void)
{
  ...
  p_instance = TELNETs_InstanceInit(DEF_NULL, //&telnet_p_cfg,
