...
static  const  NET_IF_ETHER_CFG  Ex_NetIF_CfgDflt_Ether = {
        ...
        .IPv4.Static.Addr              = "192.168.1.199",
        .IPv4.Static.Mask              = "255.255.255.0",
...
void  Ex_Net_CoreStartEther (void)
{
    ...
    NetASCII_Str_to_IP("192.168.1.199",
                       &addr_ipv4,
                        NET_IPv4_ADDR_SIZE,
                       &err);
    APP_RTOS_ASSERT_CRITICAL((err.Code == RTOS_ERR_NONE), ;);
    ...
    NetASCII_Str_to_IP("192.168.1.5",                            /* Convert Gateway string address to 32 bit address.    */
                       &gateway_ipv4,
                        NET_IPv4_ADDR_SIZE,
                       &err);
    APP_RTOS_ASSERT_CRITICAL((err.Code == RTOS_ERR_NONE), ;);
