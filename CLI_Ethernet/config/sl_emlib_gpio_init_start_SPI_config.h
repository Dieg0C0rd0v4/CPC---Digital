#ifndef SL_EMLIB_GPIO_INIT_START_SPI_CONFIG_H
#define SL_EMLIB_GPIO_INIT_START_SPI_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_START_SPI_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_START_SPI_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_START_SPI_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_START_SPI_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_START_SPI
// $[GPIO_SL_EMLIB_GPIO_INIT_START_SPI]
#define SL_EMLIB_GPIO_INIT_START_SPI_PORT        gpioPortC
#define SL_EMLIB_GPIO_INIT_START_SPI_PIN         4
// [GPIO_SL_EMLIB_GPIO_INIT_START_SPI]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_START_SPI_CONFIG_H
